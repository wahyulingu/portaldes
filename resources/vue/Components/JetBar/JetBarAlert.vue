    ...
    <transition name="fade">
        <div v-if="text && show" class="alert mb-8 flex items-center justify-between rounded w-full" :class="alertColor">
            <div class="flex items-center">
                <svg viewBox="0 0 20 20" fill="currentColor" class="check w-6 h-6 fill-current ml-4 mr-2 flex-shrink">
            ...
            <button type="button" class="group mr-2 p-2 focus:outline-none" @click="show = false">
                <svg class="block w-2 h-2 fill-green-700" xmlns="http://www.w3.org/2000/svg" width="235.908"
