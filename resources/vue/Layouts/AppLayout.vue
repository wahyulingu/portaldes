                    ...
                    <div class="flex justify-between h-12">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavDropdown align="left" prefix="dashboard.content">
                                    Content
                                    <template #content>
                                ...
                                <NavDropdown align="left" prefix="dashboard.peta">
                                    Media
                                    <template #content>
                                        <div class="block px-4 py-2 text-xs text-gray-400">
                                            Manage Peta
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <NavDropdown prefix="dashboard.user">
                                ...
                                <template #content>
                                    ...
                                    <DropdownLink :href="route('dashboard.user.profile.show')">
                                        Profile
                                    </DropdownLink>

                                    <DropdownLink v-if="$page.props.jetstream.hasApiFeatures"
                                        :href="route('dashboard.user.api-tokens.index')">
                                        API Tokens
                                    </DropdownLink>
